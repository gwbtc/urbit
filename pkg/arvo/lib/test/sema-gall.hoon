...
/=  sema-raw  /sys/vane/sema
/=  gall-raw  /sys/vane/gall
::
=/  sema-bunt  (sema-raw ~zod)
=/  gall-bunt  (gall-raw ~zod)
::  basic helpers
::
|%
++  crypto-core
  |%  ++  nec  (pit:nu:cric:crypto 512 (shaz 'nec'))
      ++  bud  (pit:nu:cric:crypto 512 (shaz 'bud'))
      ++  sign
        |=  [=ship data=@ux]
        %.  data
...
++  sema-nec-bud
  ...
  ::
  =/  nec-sym  (derive-symmetric-key:sema-raw bud-pub nec-sec)
  =/  bud-sym  (derive-symmetric-key:sema-raw nec-pub bud-sec)
  ?>  =(nec-sym bud-sym)
  ::  tell ~nec about ~bud
  ::
...
=/  sema-adult  nec:(sema-nec-bud [1 1] [0 0])
::  main core
::
|%
+$  gall-gate  _gall-adult
+$  sema-gate  _sema-adult
::
++  nec-bud
  |=  [life=[nec=@ud bud=@ud] rift=[nec=@ud bud=@ud]]
  =/  a  (sema-nec-bud [nec bud]:life [nec bud]:rift)
...
++  sema-scry-hunk
  ...
  ::
  :-  sig:(sift-roar:sema-raw (lent paz) (flop paz))
  %+  spun  meows
  |=  [meow=@ux num=_1]
  :_  +(num)
